...
# The dictionary to decode these is created in [`../auxiliary/CCACTODE`](https://db.core.data.digital.nhs.uk/#notebook/5445633/command/5445666) and stored in `.ccu029_lkp_ccactcode`
